...
> Esta guía solo funciona para Linux y macOS, ya que exa aún no tiene soporte para Windows 🫣. pero podria omitir [exa](https://the.exa.website/)

## Lista de herramnetas 
...
Con Homebrew ejecute el siguinte comando para realizar la instalacion:
...
> Instala en otros sistemas operativos con solo seguir la guia oficial [desde el repositorio oficial](https://github.com/vercel/hyper#usage)
