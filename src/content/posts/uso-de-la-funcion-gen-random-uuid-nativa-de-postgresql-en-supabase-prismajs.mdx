---
title: gen_random_uuid() Postgresql + Supabase + Prismajs
...
<Image
  alt="prisma"
  src="/images/blog/uso-de-la-funcion-gen-random-uuid-nativa-de-postgresql-en-supabase-prismajs/exmple_0.webp"
  width={1024}
  height={500}
  quality="75"
/>
