...
image: '/static/images/blog/embellecer-importaciones-absolutas-con-alias-en-nextjs/alias-01.png'
tags: ['react', 'nextjs', 'nextjsV9.4', 'javaScript']
---

Estas trabajando en un proyecto grande o pequeño y algunas de sus declaraciones de importación se ven algo asi `import Component from '../../../Component'`.
