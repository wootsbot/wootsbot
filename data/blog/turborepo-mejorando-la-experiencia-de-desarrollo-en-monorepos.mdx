...
summary: 'Turborepo Mejorando La Experiencia De Desarrollo En Monorepos, TurboRepo será una gran tendencia este año 2022, por lo que rápidamente me di a la tarea de escribir y tratar de explicar
qué es, cómo usar TurboRepo y cómo reinventa las técnicas del sistema de compilación para mejorar la experiencia de desarrollo con monorepos.'
image: '/static/images/blog/turborepo-mejorando-la-experiencia-de-desarrollo-en-monorepos/preview.png'
tags: ['TurboRepo', 'DX', 'turborepo', 'turbo', 'repo', 'monorepos', 'JavaScript', 'TypeScript', 'next', 'vercel']
---

[TurboRepo](https://turborepo.org/) será una gran tendencia este año 2022, por lo que rápidamente me di a la tarea de escribir y tratar de explicar
qué es, cómo usar TurboRepo y cómo reinventa las técnicas del sistema de compilación para mejorar la experiencia de desarrollo con monorepos.
...
que lo tomará de la memoria caché.
