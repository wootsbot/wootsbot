...
publishedAt: 2023-03-31T00:00:00Z
summary: Codifica a la velocidad del pensamiento, Zed el mejor editor de texto del mundo para usted y equipo, un editor de código multijugador de alto rendimiento de los creadores de Atom y Tree-sitter
...
<Image
  className="w-full rounded-lg my-8 outline outline-offset-2 outline-lime-950/50"
  alt="starlink order confirm"
  src="/images/blog/zed-el-mejor-editor-de-texto-del-mundo/add-contact.webp"
  width={622}
  height={437}
  quality="75"
/>
...
<Image
  className="w-full rounded-lg my-8 outline outline-offset-2 outline-lime-950/50"
  alt="starlink order confirm"
  src="/images/blog/zed-el-mejor-editor-de-texto-del-mundo/sharing-a-project.webp"
  width={622}
  height={437}
  quality="75"
/>
...
<Image
  className="w-full rounded-lg my-8 outline outline-offset-2 outline-lime-950/50"
  alt="starlink order confirm"
  src="/images/blog/zed-el-mejor-editor-de-texto-del-mundo/accepting-an-invite.webp"
  width={622}
  height={437}
  quality="75"
/>
...
<Image
  className="w-full rounded-lg my-8 outline outline-offset-2 outline-lime-950/50"
  alt="starlink order confirm"
  src="/images/blog/zed-el-mejor-editor-de-texto-del-mundo/code-actions.webp"
  width={622}
  height={437}
  quality="75"
/>
...
<Image
  className="w-full rounded-lg my-8 outline outline-offset-2 outline-lime-950/50"
  alt="starlink order confirm"
  src="/images/blog/zed-el-mejor-editor-de-texto-del-mundo/breadcrumb.webp"
  width={622}
  height={437}
  quality="75"
/>
